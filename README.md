...
This image is available as a [trusted build](//hub.docker.com/u/sameersbn/nginx) on the [Docker hub](//hub.docker.com) and is the recommended method of installation.

```bash
docker pull sameersbn/nginx:1.8.0-2
```
